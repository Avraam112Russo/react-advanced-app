...
import cls from "entities/singleArticle/ui/articleListItem/ArticleListItem.module.scss";
...
export const ArticleListItemSkeleton = (props:ArticleListItemSkeletonProps) => {
    ...
    if (view === ArticleViewType.SMALL){
        ...
        <Skeleton width={130} height={16} className={cls.types}/>{/*join types singleArticle (science, it, etc)*/}
        </div>
